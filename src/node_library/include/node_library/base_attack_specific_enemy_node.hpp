#ifndef RM_SENTRY_2024_BASE_ATTACK_SPECIFIC_ENEMY_
#define RM_SENTRY_2024_BASE_ATTACK_SPECIFIC_ENEMY_
...
namespace BehaviorTree{
    class BaseAttackSpecificEnemyNode:public BT::SyncActionNode{
        private:
        public:
            ...
            BaseAttackSpecificEnemyNode(const std::string&name, const BT::NodeConfig& config);
