...
namespace BehaviorTree{
    ...
    OperatorNavigateNode::OperatorNavigateNode(const std::string&name, const BT::NodeConfig& config):
                BT::SyncActionNode(name,config){
                    ...
                    subscription_operator_cmd = node1->create_subscription<robot_msgs::msg::OpCmd>("autoaim2decision",10,std::bind(&OperatorNavigateNode::message_callback_operator_cmd,this,std::placeholders::_1));
                    flag = 0;
                }
